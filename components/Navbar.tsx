    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 md:h-24">
          <Link href="/" className="flex items-center animate-fade-in group">
            <span className="text-2xl font-black tracking-widest bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent group-hover:opacity-80 transition-opacity duration-200">
              ANTIC
            </span>
            <span className="text-2xl font-black tracking-widest text-white ml-2 group-hover:opacity-80 transition-opacity duration-200">
              AGENCY
            </span>
          </Link>
